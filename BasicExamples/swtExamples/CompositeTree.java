 ...
 * <Lars.Vogel@vogella.com> - Bug 502845
 *******************************************************************************/
...
public class CompositeTree {
	...
	public static void main(String[] args) {
		...
		/*
		 * The following listener ensures that the Tree is always large enough to not need to show its
		...
		/*
		 * The following listener ensures that a newly-selected item in the Tree is always visible.
		 */
		...
		/*
		 * The following listener scrolls the Tree one item at a time in response to MouseWheel events.
		 */

...
/**
 * Basic example of an application with a graphical user interface developed with SWT. It shows a
 * button in the middle of the screen. When pressed, the application terminates.
 * 
